  ...
  return (
    <div id='book' className='overflow-hidden flex justify-center items-center p-5 max-md:flex-col max-sm:gap-3'>
      ...
      >
        ...
        {/* Page 3 */}
        <div className="custom-scroll overflow-y-scroll flex flex-col justify-center items-center p-5 bg-gradient-to-bl from-sky-100 via-blue-200 to-indigo-300 rounded-sm page">
        ...
        {/* Page 4 */}
        <div className="custom-scroll overflow-y-scroll flex flex-col justify-center items-center p-5 bg-gradient-to-r from-pink-100 via-rose-200 to-red-300 rounded-sm page">
          <p className="text-base text-gray-700 whitespace-pre-line">{data[active].page1}</p>
          <p className="text-sm text-gray-500 text-center mt-2">- 4 -</p>
        </div>

        {/* Page 5 */}
        <div className="custom-scroll overflow-y-scroll flex flex-col justify-center items-center p-5 bg-gradient-to-tl from-orange-100 via-amber-200 to-yellow-300 rounded-sm">
          <p className="text-base text-gray-700 whitespace-pre-line page">{data[active].page1}</p>
          <p className="text-sm text-gray-500 text-center mt-2">- 5 -</p>
        </div>

        {/* Page 6 */}
        <div className="custom-scroll overflow-y-scroll flex flex-col justify-center items-center p-5 bg-gradient-to-b from-purple-100 via-violet-200 to-fuchsia-300 rounded-sm page">
          <p className="text-base text-gray-700 whitespace-pre-line">{data[active].page1}</p>
